  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Header Navbar -->
        <?php $this->load->view('admin_parts/header')?>
      <!-- Left side column. contains the logo and sidebar -->
      <!-- main-sidebar -->
        <?php $this->load->view('admin_parts/main_sidebar')?>
     ...
     $data = array(
      ...
      <!-- Main Footer -->
      <?php $this->load->view('admin_parts/footer') ?>

      <!-- Control Sidebar -->
      <?php $this->load->view('admin_parts/control_sidebar')?>
