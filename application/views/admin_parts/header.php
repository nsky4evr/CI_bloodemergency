              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href='<? echo base_url()."admin_ctrl/profile" ?>' class="btn btn-default btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href='<?php echo base_url()."admin_ctrl/signout"?>' class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
